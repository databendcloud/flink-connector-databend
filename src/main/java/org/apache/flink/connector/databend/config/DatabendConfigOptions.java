...
public class DatabendConfigOptions {
    public static final ConfigOption<String> URL =
            ConfigOptions.key(DatabendConfig.URL)
                    .stringType()
                    .noDefaultValue()
                    .withDescription("The Databend url in format `databend://<host>:<port>`.");

    public static final ConfigOption<String> USERNAME =
            ConfigOptions.key(DatabendConfig.USERNAME)
                    .stringType()
                    .noDefaultValue()
                    .withDescription("The Databend username.");

    public static final ConfigOption<String> PASSWORD =
            ConfigOptions.key(DatabendConfig.PASSWORD)
                    .stringType()
                    .noDefaultValue()
                    .withDescription("The Databend password.");

    public static final ConfigOption<String> DATABASE_NAME =
            ConfigOptions.key(DatabendConfig.DATABASE_NAME)
                    .stringType()
    ...
    public static final ConfigOption<String> TABLE_NAME =
            ConfigOptions.key(DatabendConfig.TABLE_NAME)
                    .stringType()
                    .noDefaultValue()
    ...
    public static final ConfigOption<Integer> SINK_BATCH_SIZE =
            ConfigOptions.key(DatabendConfig.SINK_BATCH_SIZE)
                    .intType()
                    .defaultValue(1000)
                    .withDescription(
    ...
    public static final ConfigOption<Duration> SINK_FLUSH_INTERVAL =
            ConfigOptions.key(DatabendConfig.SINK_FLUSH_INTERVAL)
                    .durationType()
    ...
    public static final ConfigOption<Integer> SINK_MAX_RETRIES =
            ConfigOptions.key(DatabendConfig.SINK_MAX_RETRIES)
                    .intType()
                    .defaultValue(3)
                    .withDescription("The max retry times if writing records to database failed.");

    public static final ConfigOption<SinkUpdateStrategy> SINK_UPDATE_STRATEGY =
            ConfigOptions.key(DatabendConfig.SINK_UPDATE_STRATEGY)
    ...
    public static final ConfigOption<Boolean> SINK_IGNORE_DELETE =
            ConfigOptions.key(DatabendConfig.SINK_IGNORE_DELETE)
                    .booleanType()
                    .defaultValue(true)
